...
class AnimacjaWczytaniaKartyMetro(ctk.CTkFrame):
    def __init__(self, app):
        ...
        self.karta_ulgowa_button = ctk.CTkButton(
            self.button_frame, text="Karta ulgowa", width=300, height=70, font=("Arial", 24, "bold"),
            command=lambda: self.process_payment("ulgowy", "OkresowyUlgowy")
        )
        self.karta_ulgowa_button.grid(row=1, column=1, padx=10, pady=90)

        self.karta_normalna_button = ctk.CTkButton(
            self.button_frame, text="Karta normalna", width=300, height=70, font=("Arial", 24, "bold"),
            command=lambda: self.process_payment("normalny", "OkresowyNormalny")
        )
        self.karta_normalna_button.grid(row=1, column=0, padx=10, pady=90)
    ...
    def run_payment_animation(self, next_screen):
        ...
        self.app.show_frame("Wybor_Rejonu_Metro",next_screen)
