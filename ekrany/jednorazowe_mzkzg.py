...
class JednorazoweMZKZG(ctk.CTkFrame):
    def __init__(self, app, selected_language):
        ...
        self.bilety = [
            ...
            {"nazwa": "24-godzinny (24.00/12.00 zł)", "normalne": 0, "ulgowe": 0, "cena": 24.00},
            {"nazwa": "72-godzinny (48.00/24.00 zł)", "normalne": 0, "ulgowe": 0, "cena": 48.00},
        ]
    ...
    def create_table_header(self):
        ...
        ctk.CTkLabel(self.table_frame, text="Bilet", font=("Arial", 32, "bold"), width=400).grid(row=0, column=0, padx=20, pady=5)
        ctk.CTkLabel(self.table_frame, text="Normalne", font=("Arial", 32, "bold"), width=300).grid(row=0, column=1, padx=20, pady=5)
        ctk.CTkLabel(self.table_frame, text="Ulgowe", font=("Arial", 32, "bold"), width=300).grid(row=0, column=2, padx=20, pady=5)
    ...
    def create_table_rows(self):
        ...
        for i, bilet in enumerate(self.bilety):
            ...
            row_frame.grid(row=i + 1, column=0, columnspan=3, padx=10, pady=8)
